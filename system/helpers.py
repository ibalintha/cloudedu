...
from system.util import (flatten_fieldsets, lookup_field,
...
class AdminReadonlyField(object):
    ...
    def contents(self):
        from system.templatetags.admin_list import _boolean_icon
        from system.views.main import EMPTY_CHANGELIST_VALUE
