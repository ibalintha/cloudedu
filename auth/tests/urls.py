...
from auth import context_processors
from auth.urls import urlpatterns
from auth.views import password_reset
...
urlpatterns = urlpatterns + patterns('',
    ...
    (r'^password_reset_from_email/$', 'auth.views.password_reset', dict(from_email='staffmember@example.com')),
