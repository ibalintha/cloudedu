...
from auth import SESSION_KEY, REDIRECT_FIELD_NAME
from auth.forms import (AuthenticationForm, PasswordChangeForm,
...
class LoginTest(AuthViewsTestCase):
    ...
    def test_security_check(self, password='password'):
        login_url = reverse('auth.views.login')
...
class LogoutTest(AuthViewsTestCase):
    ...
    def test_security_check(self, password='password'):
        logout_url = reverse('auth.views.logout')
